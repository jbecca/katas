...
pub fn sm2_algo(user_grade: Difficulty,
                repetition_number: i32,
                easiness_factor: f32,
                interval: i32) -> (i32, f32, i32) {
    ...
    let mut new_easiness_factor = easiness_factor + (0.1 - (5.0 - user_grade as isize as f32) * (0.08 + (5.0 - user_grade as isize as f32) * 0.02));
